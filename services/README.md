...
```bash
.venv/bin/pytest services/core-lib/tests services/service-commons/tests services/collector/tests services/backtest-service/tests services/signal-service/tests services/wallet-service/tests
.venv/bin/ruff check services/core-lib services/service-commons services/collector services/backtest-service services/signal-service services/wallet-service
.venv/bin/ruff format --check services/core-lib services/service-commons services/collector services/backtest-service services/signal-service services/wallet-service
