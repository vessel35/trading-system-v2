"""Read money-management registrations through the signal-service boundary."""
...
class SignalMoneyManagementRegistry(MoneyManagementRegistry):
    """Mirror the backtest adapter with a read-only signal-service view."""
    ...
    def list(self) -> list[dict[str, object]]:
        """Return policy catalog entries in stable mode order."""
