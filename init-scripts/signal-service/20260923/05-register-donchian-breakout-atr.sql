...
VALUES (
    ...
    'Donchian Breakout ATR',
    'A fresh close beyond the prior 20-bar channel enters (once per breakout); exits are the manual policy''s stop and target. Run with manual atr_stop_multiple 1.5 and reward_risk 2.0 to reproduce the source. Source: docs/samples_for_strategy_agent/04.Donchian_Breakout_ATR.md',
    '1.0.0',
    ARRAY['1h']::text[],
    '[]'::jsonb,
    21,
